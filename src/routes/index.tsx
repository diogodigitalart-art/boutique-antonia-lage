          ...
          <div className="flex flex-col items-center justify-center gap-8 md:flex-row md:gap-12">
            <div className="max-w-md text-center md:text-left">
              <p className="font-display text-2xl font-light italic leading-snug text-foreground md:text-3xl">
                Gostaste da tua experiência connosco? A tua opinião faz toda a diferença.
              </p>
              <a
                href="https://g.page/r/CebMCPIDAyVBEBM/review"
                target="_blank"
                rel="noopener noreferrer"
                className="mt-6 inline-flex items-center gap-3 rounded-full bg-white px-6 py-3 text-sm font-medium text-foreground shadow-sm transition hover:shadow-md"
              >
            ...
            <a
              ...
              aria-label="Abrir link da review no Google"
            >
              <img
                src={googleReviewQr.url}
                alt="QR code para review no Google"
                className="h-28 w-28 rounded-xl border border-border bg-white object-contain p-2 shadow-sm"
                loading="lazy"
              />
              <span className="text-xs font-light text-muted-foreground">Ou aponta a câmara</span>
            </a>
          </div>
        </div>
      </section>
